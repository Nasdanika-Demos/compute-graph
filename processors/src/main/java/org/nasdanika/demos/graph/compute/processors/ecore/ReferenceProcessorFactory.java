...
@EClassifierNodeProcessorFactory(classifierID = ComputePackage.REFERENCE)
public class ReferenceProcessorFactory {
		
	protected Context context;
	
	public ReferenceProcessorFactory(Context context) {
