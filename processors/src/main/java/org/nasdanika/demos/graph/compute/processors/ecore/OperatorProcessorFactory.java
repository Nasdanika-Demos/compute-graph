...
@EClassifierNodeProcessorFactory(classifierID = ComputePackage.OPERATOR)
public class OperatorProcessorFactory {
	
	protected Context context;
	
	public OperatorProcessorFactory(Context context) {
...
//	EList<Operand> getOperands();
	...
	@EStructuralFeatureNodeProcessorFactory(
			...
			featureID = ComputePackage.OPERATOR__OPERANDS,
			label = "Members",
