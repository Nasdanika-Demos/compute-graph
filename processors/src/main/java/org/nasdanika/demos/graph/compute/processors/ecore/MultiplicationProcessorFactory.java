...
@EClassifierNodeProcessorFactory(classifierID = ComputePackage.MULTIPLICATION)
public class MultiplicationProcessorFactory {
	
	protected Context context;
	
	public MultiplicationProcessorFactory(Context context) {
