...
public class ComputeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ComputePackage.OPERAND: {
				Operand operand = (Operand)theEObject;
				T result = caseOperand(operand);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComputePackage.OPERATOR: {
				Operator operator = (Operator)theEObject;
				T result = caseOperator(operator);
				if (result == null) result = caseOperand(operator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComputePackage.ASSIGNMENT: {
				Assignment assignment = (Assignment)theEObject;
				T result = caseAssignment(assignment);
				if (result == null) result = caseOperator(assignment);
				if (result == null) result = caseOperand(assignment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComputePackage.MULTIPLICATION: {
			...
			case ComputePackage.REFERENCE: {
				...
				if (result == null) result = caseOperand(reference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
