...
import org.nasdanika.demos.graph.compute.ComputeFactory;
...
public class ComputePackageImpl extends EPackageImpl implements ComputePackage {
	 ...
	 * @see org.nasdanika.demos.graph.compute.ComputePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EReference getReference_Variable() {
	...
	public void createPackageContents() {
		...
		createEReference(referenceEClass, REFERENCE__VARIABLE);
	}
	...
	public void initializePackageContents() {
		...
		operatorEClass.getESuperTypes().add(this.getOperand());
		...
		referenceEClass.getESuperTypes().add(this.getOperand());
		...
		initEReference(getReference_Variable(), this.getVariable(), null, "variable", null, 0, 1, Reference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
