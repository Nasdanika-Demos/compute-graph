...
public class ComputeFactoryImpl extends EFactoryImpl implements ComputeFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ComputePackage.OPERAND: return createOperand();
			case ComputePackage.OPERATOR: return createOperator();
			case ComputePackage.ASSIGNMENT: return createAssignment();
			case ComputePackage.MULTIPLICATION: return createMultiplication();
			case ComputePackage.LITERAL: return createLiteral();
			case ComputePackage.VARIABLE: return createVariable();
